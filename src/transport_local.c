 ...
 *
 * @arg \c hostname Hostname -- could be domainname or IP
 * @arg \c host_port Host port
 * @arg \c request Message to be sent to host
 * @arg \c protocol IP protocol to be used: IPPROTO_TCP or IPPROTO_UDP
 *
 * @returns 0 on success, -1 otherwise
 *
 * @note For IPPROTO_TCP, SOCK_STREAM will be used as socket type
